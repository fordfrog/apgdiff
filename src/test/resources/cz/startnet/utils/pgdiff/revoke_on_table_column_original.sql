...
GRANT SELECT(col1) ON TABLE table1 TO ellmkay;


--
-- Name: table1.col2; Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL(col2) ON TABLE table1 FROM PUBLIC;
REVOKE ALL(col2) ON TABLE table1 FROM postgres;
GRANT ALL(col2) ON TABLE table1 TO ellmkay;
...
GRANT ALL(col3) ON TABLE table1 TO ellmkay;
