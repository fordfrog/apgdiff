...
--
-- Name: type1; Type: TYPE; Schema: schema1; Owner: postgres
--
...
ALTER TYPE type1 OWNER TO postgres;

SET search_path = public, pg_catalog;

--
-- Name: function2(); Type: FUNCTION; Schema: public; Owner: marcus
--
...
ALTER FUNCTION public.function2() OWNER TO marcus;
...
ALTER TABLE view2 OWNER TO postgres;

SET search_path = schema1, pg_catalog;

--
-- Name: table1_col1_seq; Type: SEQUENCE; Schema: schema1; Owner: postgres
--
...
ALTER TABLE table1_col1_seq OWNER TO postgres;

--
-- Name: table1_col1_seq; Type: SEQUENCE OWNED BY; Schema: schema1; Owner: postgres
--
...
--
-- Name: table2; Type: TABLE; Schema: schema2; Owner: postgres
--
...
--
-- Name: table2_col1_seq; Type: SEQUENCE; Schema: schema2; Owner: postgres
--
...
ALTER TABLE table2_col1_seq OWNER TO postgres;

--
-- Name: table2_col1_seq; Type: SEQUENCE OWNED BY; Schema: schema2; Owner: postgres
--
...
--
-- Name: col1; Type: DEFAULT; Schema: schema1; Owner: postgres
--
...
--
-- Name: col1; Type: DEFAULT; Schema: schema2; Owner: postgres
--
...
--
-- Data for Name: table1; Type: TABLE DATA; Schema: schema1; Owner: postgres
--
...
--
-- Name: table1_col1_seq; Type: SEQUENCE SET; Schema: schema1; Owner: postgres
--

SELECT pg_catalog.setval('table1_col1_seq', 100, false);


SET search_path = schema2, pg_catalog;

--
-- Data for Name: table2; Type: TABLE DATA; Schema: schema2; Owner: postgres
--

COPY table2 (col1, col2, added) FROM stdin;
\.


--
-- Name: table2_col1_seq; Type: SEQUENCE SET; Schema: schema2; Owner: postgres
--
...
--
-- Name: table1_col2_key; Type: CONSTRAINT; Schema: schema1; Owner: postgres
--
...
--
-- Name: table1_pkey; Type: CONSTRAINT; Schema: schema1; Owner: postgres
--
...
--
-- Name: table1_col2_key; Type: CONSTRAINT; Schema: schema2; Owner: postgres
--
...
--
-- Name: table2_pkey; Type: CONSTRAINT; Schema: schema2; Owner: postgres
--
...
--
-- Name: table3_col2_key; Type: CONSTRAINT; Schema: schema3; Owner: ellmkay
--
...
--
-- Name: table3_pkey_new; Type: CONSTRAINT; Schema: schema3; Owner: ellmkay
--
...
--
-- Name: index1; Type: INDEX; Schema: schema1; Owner: postgres
--
...
CREATE INDEX index3 ON table3 USING btree (col2 DESC);


SET search_path = schema1, pg_catalog;

--
-- Name: trigger1; Type: TRIGGER; Schema: schema1; Owner: postgres
--
...
--
-- Name: trigger3; Type: TRIGGER; Schema: schema3; Owner: ellmkay
--

CREATE TRIGGER trigger3 AFTER INSERT ON table3 FOR EACH STATEMENT EXECUTE PROCEDURE triggfunc();


SET search_path = schema2, pg_catalog;

--
-- Name: table2_col2_fkey; Type: FK CONSTRAINT; Schema: schema2; Owner: postgres
--
...
--
-- Name: function1(); Type: ACL; Schema: schema1; Owner: ellmkay
--

REVOKE ALL ON FUNCTION function1() FROM PUBLIC;
REVOKE ALL ON FUNCTION function1() FROM ellmkay;
GRANT ALL ON FUNCTION function1() TO ellmkay;
GRANT ALL ON FUNCTION function1() TO PUBLIC;
GRANT ALL ON FUNCTION function1() TO postgres;
