...
--
-- Name: sequence3; Type: SEQUENCE; Schema: schema3; Owner: ellmkay
--
...
ALTER TABLE sequence3 OWNER TO ellmkay;
...
--
-- Name: sequence3; Type: SEQUENCE SET; Schema: schema3; Owner: ellmkay
--
...
--
-- Name: schema1; Type: ACL; Schema: -; Owner: ellmkay
--

REVOKE ALL ON SCHEMA schema1 FROM PUBLIC;
REVOKE ALL ON SCHEMA schema1 FROM ellmkay;
GRANT ALL ON SCHEMA schema1 TO ellmkay;
...
--
-- Name: sequence3; Type: ACL; Schema: schema3; Owner: ellmkay
--

REVOKE ALL ON SEQUENCE sequence3 FROM PUBLIC;
REVOKE ALL ON SEQUENCE sequence3 FROM ellmkay;
GRANT ALL ON SEQUENCE sequence3 TO ellmkay;
GRANT SELECT ON SEQUENCE sequence3 TO postgres;
...
GRANT SELECT ON TABLE table3 TO ellmkay;
