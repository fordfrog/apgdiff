 ...
 * @author fordfrog
 */
public class PgConstraintTrigger {
    ...
    /**
     * Whether the trigger should be fired AFTER an event.
     * Default is after.
     */
    private EventTimeQualification eventTimeQualification = EventTimeQualification.after;
    ...
    public String getDropSQL() {
        return "DROP CONSTRAINT TRIGGER " + PgDiffUtils.getDropIfExists() + PgDiffUtils.getQuotedName(getName()) + " ON "
    ...
    public boolean equals(final Object object) {
        ...
        if (this == object) {
            equals = true;
        } else if (object instanceof PgConstraintTrigger) {
            final PgConstraintTrigger trigger = (PgConstraintTrigger) object;
